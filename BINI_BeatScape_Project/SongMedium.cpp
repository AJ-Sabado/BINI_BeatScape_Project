...
namespace BINI
{
	...
	SongMedium::SongMedium(BINI::Renderer* renderer)
	{
		//Textures
	...
	void SongMedium::display(BINI::Renderer* renderer)
	{
		//Beat pulse
		...
		if (fadingIn || accuracy < 65.f || beat > 936)
	...
	Uint8 SongMedium::barHighlightsfadeOut(Uint8 highlight)
	{
		if (highlight - 10 < 0)
		{
			return 0;
